...
# loading zdata_bao for corresponding functions. __init__ is called here.
...
with model:
	...
	newpath = r'/home/hpadmin/govind/hz_bao_pantheon_cmb/hz_bao_pantheon_cmb_chains' 
	...
	for j in range(no_of_chains):
	    fout = open('hz_bao_pantheon_cmb_chains/chain__' 
	                + str(j+1) + '.txt', "w")
	    for i in range(n):
